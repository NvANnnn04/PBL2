...
bool adminLogin();
void adminMenu(LinkedlistPhong& listphong);
...
bool adminLogin() {
	...
	cout << "\n========== DANG NHAP ADMIN ==========\n";
	while (true) {
		cout << "Nhap mat khau cho admin: ";
		getline(cin, password);
		if (password == adminPassword) {
			cout << "Dang nhap thanh cong admin!\n";
			return true;
		}
		cout << "Vui long thu lai mat khau!\n";
		return false;
	}
}
...
void PhongMenu(LinkedlistPhong& listphong) {
    ...
    do {
        cout << "\n========== QUAN LY PHONG ==========\n";
        cout << "1. Hien thi danh sach cac phong\n";
        cout << "2. Cap nhat trang thai phong\n";
        cout << "3. Tim phong\n";
        cout << "4. Xoa phong\n";
        cout << "5. Sua lai thong tin phong\n";
        cout << "6. Tinh gia tien phong\n";
        cout << "7. Them phong moi\n";
        cout << "0. Quay lai\n";
        cout << "Hay nhap lua chon: ";
        cin >> choice;
        cin.ignore();
   		...
   		switch (choice) {
            ...
            case 2: {
                ...
                if (listphong.updateRoom(roomID, newtrangthai)) {
                	cout << "Trang thai phong da cap nhat thanh cong." << endl;
				} else {
					cout << "Cap nhat trang thai phong that bai, vui long thu lai!" << endl;
				}
				cout << "Danh sach phong sau khi cap nhat:\n";
       			listphong.displayRooms();
                break;
            }
            case 3: {
            ...
            case 5: {
                ...
                Phong* room = listphong.findRoom(roomID);
                if (room != nullptr) {
                    cout << "\nThong tin hien tai cua phong:\n";
                    cout << "=============================================================================\n";
                    room->displayRoomInfo();
                    cout << "=============================================================================\n";
                    
                    if (listphong.editRoom(roomID)) {
            ...
            case 6: {
                ...
                if (room != nullptr) {
                    ...
                    cout << "Nhap thoi gian check-in (ngay thang nam gio): ";
                    cin >> ngayVao >> thangVao >> namVao >> gioVao;
                    while (gioVao < 0 || gioVao > 23) {
                        cout << "Gio khong hop le! Vui long nhap lai (0-23): ";
                        cin >> gioVao;
                    }
                    
                    cout << "Nhap thoi gian check-out (ngay thang nam gio): ";
                    cin >> ngayRa >> thangRa >> namRa >> gioRa;
                    while (gioRa < 0 || gioRa > 23) {
                        cout << "Gio khong hop le! Vui long nhap lai (0-23): ";
                        cin >> gioRa;
                    }
                    checkin.tm_mday = ngayVao;
                    ...
                    cout << "\n=============================================================================\n";
                    cout << "Thong tin tinh tien phong " << roomID << ":\n";
                    cout << "Loai phong: " << room->getRoomType() << endl;
                    cout << "Gia phong/gio: " << room->getRoomPrice() << " VND" << endl;
                    cout << "Thoi gian check-in: " << ngayVao << "/" << thangVao << "/" << namVao << " " << gioVao << ":00" << endl;
                    cout << "Thoi gian check-out: " << ngayRa << "/" << thangRa << "/" << namRa << " " << gioRa << ":00" << endl;
                    cout << "Thoi gian thue: " << room->thoigianthue() << " gio" << endl;
                    cout << "Tong tien: " << room->tienthuephong() << " VND" << endl;
                    cout << "=============================================================================\n";
                } else {
            ...
            case 7: {
                ...
                int trangthai; 
                while (true) {
                    cout << "Nhap trang thai phong (1 - Trong, 0 - Da co khach): ";
                    cin >> trangthai;
                    if (trangthai == 0 || trangthai == 1) {
                        isAvailable = (trangthai == 1);
                        break;
                    } else {
                        cout << "Gia tri khong hop le, vui long thu lai.\n";
                    }
